...
"""
        ...
        if report.detections:
            ...
            for d in report.detections:
                packed_tag = '<span class="tag danger">YES</span>' if d.is_packed else '<span class="tag ok">NO</span>'
        ...
        if report.unpack_result:
            ...
            status = '<span class="tag ok">SUCCESS</span>' if ur.success else '<span class="tag danger">FAILED</span>'
